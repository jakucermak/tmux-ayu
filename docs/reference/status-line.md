...
The tmux status line modules are set as variables and prefixed with `@ayu_status_<module>`.
...
set -g status-right "#{E:@ayu_status_application}#{E:@ayu_status_session}"
set -g status-left ""
```
...
```sh
set -g @ayu_[module_name]_[option] ""
```
...
set -g status-left "#{E:@ayu_status_session}"

set -g status-right "#{E:@ayu_status_[module_name]}"
set -ag status-right "#{E:@ayu_status_[module_name]}"
set -agF status-right "#{E:@ayu_status_[module_name]}"
...
set -agF status-right "#{E:@ayu_status_weather}"
...
set -agF status-right "#{E:@ayu_status_clima}"
...
set -agF status-right "#{E:@ayu_status_load}"
```
...
set -agF status-right "#{@ayu_status_gitmux}"
```
...
set -agF status-right "#{E:@ayu_status_pomodoro_plus}"
...
set -agF status-right "#{E:@ayu_status_kube}"
