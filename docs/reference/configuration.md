...
set -g @ayu_menu_selected_style "fg=#{@thm_ui_panel},bg=#{@thm_yellow}"
```
...
set -g @ayu_pane_background_color "#{@thm_ui_panel}"
...
set -g @ayu_window_text_color "#{@thm_ui_panel}"
set -g @ayu_window_number_color "#{@thm_ui_gutter}"
set -g @ayu_window_text " #T"
set -g @ayu_window_number "#I"
set -g @ayu_window_current_text_color "#{@thm_ui_selection}"
...
set -g @ayu_status_module_bg_color "#{@thm_ui_panel}"
```
