...
function reset() {
  tmux set -gu @ayu_window_current_left_separator
  tmux set -gu @ayu_window_current_middle_separator
  tmux set -gu @ayu_window_current_right_separator
  tmux set -gu @ayu_window_status_style
}
...
reset
tmux set -g @ayu_window_status_style "rounded"
tmux source "${script_dir}/../ayu_options_tmux.conf"
tmux source "${script_dir}/../ayu_tmux.conf"
...
reset
tmux set -g @ayu_window_number_position "right"
tmux source "${script_dir}/../ayu_options_tmux.conf"
tmux source "${script_dir}/../ayu_tmux.conf"
